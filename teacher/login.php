...
function getmaterials() {
  ...
  $.ajax({
        ...
        document.getElementById('rmaterial_id').innerHTML = dataResult;
        document.getElementById('drmaterial_id').style.display = "";
        }
  });
  } else {
    document.getElementById('drmaterial_id').style.display = "none";
...
var school_id = document.getElementById('rschool_id').value;
var material_id = document.getElementById('rmaterial_id').value;
