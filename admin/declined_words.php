...
include('declined_words_lang.php');
?>
<!DOCTYPE html>
                ...
                <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
                    ...
                    <div class="product-list">
                        ...
                        <div class="row border-bottom mb-4">
                            <div class="col-sm-8 pt-2"><h6 class="mb-4 bc-header"><i class="fas fa-comment-slash"></i> <?php echo $declined_words; ?></h6></div>
                            <div class="col-sm-4 text-right pb-3">
                                <button class="btn btn-outline-theme shadow" data-toggle="modal" data-target="#addWord">
                                    <i class="fas fa-plus"></i> <?php echo $addword; ?>
                                </button>
                            </div>
                        </div>
...
$sql = "SELECT * FROM declined_words";
}else{
$sql = "SELECT * FROM declined_words WHERE school_id='$_COOKIE[school_id]'";
}
$i = 1;
$result = $conn->query($sql);
...
<td class="align-middle"><?php echo "$row[word]"; ?></td>
<?php if($_COOKIE['user_type'] == "superadmins" AND $_COOKIE['id'] == 1){ ?>
...
<td class="align-middle text-center">
    <button class="btn btn-danger" onclick="delword(<?php echo "$row[id]"; ?>)"><i class="fas fa-trash"></i></button>
</td>
</tr>
<?php
  }}
...
?>
                    ...
                    <!--Word Add Modal-->
                    <div class="modal fade" id="addWord" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle"><?php echo $addword; ?></h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="text" class="form-control" id="awname">
                                    ...
                                    <select class="form-control" id="awschool" onchange="getclasses('amschool', '', 'amclass')">
                                        <option value=""><?php echo $school; ?></option>
<?php
include('../db.php');
$sql = "SELECT * FROM schools";
...
?>
                                ...
                                <button class="btn btn-outline-success" id="addwordbtn" onclick="addword()"><i class="fas fa-save"></i> <?php echo $save; ?></button>
...
function addword() {
var word = document.getElementById('awname').value;
var school_id = document.getElementById('awschool').value;
if(word == '' || school_id == '') {
    ...
    $.ajax({
        ...
        beforeSend: function(){
            ...
            document.getElementById('addwordbtn').innerHTML = "<i class='fa fa-spinner fa-spin'></i>";
        },
